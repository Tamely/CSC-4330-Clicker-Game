...
draw_set_color(#c0d9de);

// Draw our stats
draw_text(room_width * 0.925, room_height / 2.0, $"Intel: {intelligence}");
draw_text(room_width * 0.925, room_height / 1.8, $"Social: {social}");
draw_text(room_width * 0.925, room_height / 1.65, $"Energy: {energy}");
...
draw_text(room_width * 0.925, room_height / 1.2, _mins + ":" + _seconds);
